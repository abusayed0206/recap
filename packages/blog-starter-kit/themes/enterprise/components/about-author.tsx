		...
		<div className="mx-auto mb-5 mt-10 flex w-full flex-col gap-16 px-5 md:max-w-screen-md">
			<div className="flex-1 px-2">
				<div className="flex flex-col flex-wrap items-start md:flex-nowrap">
					<h3 className="border-b-1-1/2 mb-4 w-full pb-2 text-center text-base font-medium tracking-wider text-slate-500 dark:border-slate-800 dark:text-slate-400">
						recapped by
					</h3>
